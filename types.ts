...
export type ViewState = 
  | 'COMMAND' | 'COMMAND_GLOBAL_OVERVIEW' | 'COMMAND_LIVE_MAP' | 'COMMAND_ZONE_FLUX' | 'COMMAND_ALERTS' | 'COMMAND_EXECUTIVE_REPORTS'
  | 'RISK' | 'RISK_DASHBOARD' | 'RISK_FAILURES' | 'RISK_TRANSACTIONS' | 'RISK_QUARANTINE' | 'RISK_RULE_ENGINE' | 'RISK_BLACKLISTS'
